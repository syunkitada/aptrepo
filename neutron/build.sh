...
mkdir -p ${PKG_DIR}/etc/${NAME}/plugins/ml2
cp -r ${WORK_DIR}/${NAME}-${VERSION}/etc/* ${PKG_DIR}/etc/${NAME}
cp -r ${WORK_DIR}/${NAME}-${VERSION}/etc/neutron/rootwrap.d ${PKG_DIR}/etc/${NAME}/rootwrap.d
touch ${PKG_DIR}/etc/${NAME}/neutron.conf
touch ${PKG_DIR}/etc/${NAME}/dhcp_agent.ini
touch ${PKG_DIR}/etc/${NAME}/metadata_agent.ini
touch ${PKG_DIR}/etc/${NAME}/l3_agent.ini
touch ${PKG_DIR}/etc/${NAME}/neutron_lbaas.conf
touch ${PKG_DIR}/etc/${NAME}/lbaas_agent.ini
touch ${PKG_DIR}/etc/${NAME}/plugins/ml2/ml2_conf.ini
touch ${PKG_DIR}/etc/${NAME}/plugins/ml2/linuxbridge_agent.ini
touch ${PKG_DIR}/etc/${NAME}/plugins/ml2/openvswitch_agent.ini
